/* Copyright (C) 2001 and 2004 Chris Vine
 ...
 as follows:
   ...
   with this source code package in the src/utils sub-directory); if
...
modifications of the source code in this file).
 ...
 this behaviour is not wanted, pass `false' as the second argument of
...
#include "prog_defs.h"  // for HAVE_ATTACH and ssize_t
...
namespace Attachable {
  typedef fdostream Out;
  typedef fdistream In;
} // namespace Attachable
*/
