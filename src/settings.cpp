...
void IdentityPageCB::identity_page_button_clicked(GtkWidget* widget_p, void* data) {
  ...
  instance_p->show_help_sig(instance_p->help_messages.get_message(message_index),
...
IdentityPage::IdentityPage(const int standard_size):
  ...
  gtk_widget_set_size_request(name_entry_p, standard_size * 7, standard_size);
  ...
  gtk_tooltips_set_tip(tooltips_p, name_help_button_p,
		       help_messages.get_message(IdentityMessages::name).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, number_help_button_p,
...
ModemPage::ModemPage(const int standard_size):
  ...
  gtk_widget_set_size_request(device_entry_p, standard_size * 7, standard_size);
  gtk_widget_set_size_request(lock_entry_p, standard_size * 7, standard_size);
  gtk_widget_set_size_request(capabilities_entry_p, standard_size * 7, standard_size);
  ...
  gtk_widget_set_size_request(rings_spin_button_p, -1, standard_size);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, device_help_button_p,
		       help_messages.get_message(ModemMessages::device).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, lock_help_button_p,
		       help_messages.get_message(ModemMessages::lock).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, capabilities_help_button_p,
		       help_messages.get_message(ModemMessages::capabilities).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, rings_help_button_p,
		       help_messages.get_message(ModemMessages::rings).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, class_help_button_p,
		       help_messages.get_message(ModemMessages::modem_class).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, dialmode_help_button_p,
...
#  endif // HAVE_STREAM_IMBUE
  ...
  strm << gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(rings_spin_button_p)) << std::ends;
  const char* val = strm.str();
  std::string return_val(val);
  delete[] val;
  return return_val;

#endif // HAVE_STRINGSTREAM
}
...
void ModemPage::set_dialmode(const std::string& mode_string) {
  ...
  std::string temp(Utf8::to_lower(mode_string));
...
ParmsPage::ParmsPage(const int standard_size): 
  ...
  gtk_widget_set_size_request(init_entry_p, standard_size * 7, standard_size);
  gtk_widget_set_size_request(reset_entry_p, standard_size * 7, standard_size);
  gtk_widget_set_size_request(parms_entry_p, standard_size * 7, standard_size);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, init_help_button_p,
		       help_messages.get_message(ParmsMessages::init).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, reset_help_button_p,
		       help_messages.get_message(ParmsMessages::reset).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, parms_help_button_p,
...
PrintPage::PrintPage(const int standard_size):
  ...
  GtkWidget* shrink_label_p = gtk_label_new(gettext("Print Shrink (50-100):"));
  ...
  gtk_widget_set_size_request(command_entry_p, standard_size * 7, standard_size);
  ...
  gtk_widget_set_size_request(shrink_spin_button_p, -1, standard_size);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, gtkprint_help_button_h,
		       help_messages.get_message(PrintMessages::gtkprint).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, command_help_button_p,
		       help_messages.get_message(PrintMessages::command).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, shrink_help_button_p,
		       help_messages.get_message(PrintMessages::shrink).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, popup_help_button_p,
...
#  endif // HAVE_STREAM_IMBUE
  ...
  strm << gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(shrink_spin_button_p)) << std::ends;
  const char* val = strm.str();
  std::string return_val(val);
  delete[] val;
  return return_val;
...
void PrintPage::set_gtkprint(const std::string& gtkprint_string) {
  std::string temp(Utf8::to_lower(gtkprint_string));
#if !(GTK_CHECK_VERSION(2,10,0))
  temp = "no";
#endif
  if (!temp.compare("no")) {
...
void PrintPage::set_popup(const std::string& popup_string) {
  std::string temp(Utf8::to_lower(popup_string));
  if (!temp.compare("no")) {
...
void ViewPageCB::view_page_button_clicked(GtkWidget*, void* data) {
  ...
  instance_p->show_help_sig(instance_p->help_messages.get_message(ViewMessages::ps_view_command),
...
ViewPage::ViewPage(const int standard_size):
  ...
  gtk_widget_set_size_request(ps_view_command_entry_p, standard_size * 7, standard_size);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, ps_view_command_help_button_p,
...
SockPage::SockPage(const int standard_size):
  ...
  gtk_widget_set_size_request(port_spin_button_p, -1, standard_size);
  ...
  gtk_table_attach(table_p, run_server_label_p,
		   0, 1, 0, 1,
		   GTK_FILL, GTK_SHRINK,
		   standard_size/4, standard_size/3);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, run_server_help_button_p,
		       help_messages.get_message(SockMessages::run_server).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, popup_help_button_p,
		       help_messages.get_message(SockMessages::popup).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, port_help_button_p,
		       help_messages.get_message(SockMessages::port).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, client_address_help_button_p,
...
#  endif // HAVE_STREAM_IMBUE
  ...
  strm << gtk_spin_button_get_value_as_int(GTK_SPIN_BUTTON(port_spin_button_p)) << std::ends;
  const char* val = strm.str();
  std::string return_val(val);
  delete[] val;
  return return_val;
...
void SockPage::set_run_server(const std::string& run_server_string) {
  ...
  std::string temp(Utf8::to_lower(run_server_string));
  if (!temp.compare("yes")) {
...
void SockPage::set_if_other_address(const std::string& if_other_address_string) {
  ...
  std::string temp(Utf8::to_lower(if_other_address_string));
...
ReceivePage::ReceivePage(const int standard_size):
  ...
  gtk_widget_set_size_request(prog_entry_p, standard_size * 7, standard_size);
  ...
  gtk_tooltips_set_tip(tooltips_p, exec_help_button_p,
...
void ReceivePage::set_exec(const std::string& exec_string) {
  ...
  std::string temp(Utf8::to_lower(exec_string));
  if (!temp.compare("yes")) {
...
void SendPageCB::send_page_button_clicked(GtkWidget* widget_p, void* data) {
  ...
  int message_index;
  if (widget_p == instance_p->res_help_button_p) {
...
SendPage::SendPage(const int standard_size):
  ...
  gtk_widget_set_size_request(dial_prefix_entry_p, standard_size * 7, standard_size);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, res_help_button_p,
		       help_messages.get_message(SendMessages::res).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, header_help_button_p,
		       help_messages.get_message(SendMessages::header).c_str(), "");
  gtk_tooltips_set_tip(tooltips_p, dial_prefix_help_button_p,
...
void SendPage::set_res(const std::string& res_string) {
  ...
  std::string temp(Utf8::to_lower(res_string));
...
void SendPage::set_addr_in_header(const std::string& header_string) {
  ...
  std::string temp(Utf8::to_lower(header_string));
  if (!temp.compare("no")) {
...
void LoggingPageCB::logging_page_button_clicked(GtkWidget*, void* data) {
  ...
  instance_p->show_help_sig(instance_p->help_messages.get_message(LoggingMessages::logfile),
...
LoggingPage::LoggingPage(const int standard_size):
  ...
  gtk_widget_set_size_request(logfile_entry_p, standard_size * 7, standard_size);
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, logfile_help_button_p,
...
void PagePageCB::page_page_button_clicked(GtkWidget* widget_p, void* data) {
  ...
  instance_p->show_help_sig(instance_p->help_messages.get_message(PageMessages::page),
...
PagePage::PagePage(const int standard_size):
  ...
  GtkTooltips* tooltips_p = gtk_tooltips_new();
  gtk_tooltips_set_tip(tooltips_p, page_help_button_p,
...
void PagePage::set_page(const std::string& page_string) {
  ...
  std::string temp(Utf8::to_lower(page_string));
  if (!temp.compare("a4")) {
    gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(a4_button_p), true);
  }
...
SettingsDialog::SettingsDialog(const int size, GtkWindow* parent_p, bool skip_old_settings):
  ...
  identity_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  modem_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  parms_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  print_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  view_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  sock_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  receive_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  send_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  logging_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
  page_page.show_help_sig.connect(sigc::mem_fun(*this, &SettingsDialog::show_help));
...
void SettingsDialog::get_reset_settings_prompt(void) {
  ...
  dialog_p->accepted.connect(sigc::mem_fun(*this, &SettingsDialog::get_reset_settings));
...
void SettingsDialog::show_help(const std::string& message, const std::string& caption) {
  new SettingsHelpDialog(standard_size,
			 message, caption, get_win());
