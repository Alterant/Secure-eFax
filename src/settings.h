...
namespace { // we put the function in anonymous namespace in settings.cpp
...
class SettingsDialog: public sigc::trackable, public WinBase {
...
public:
  ...
  // returned by configure_prog() together with a bool indicating
  // whether the socket server should be running
